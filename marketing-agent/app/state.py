...
SLIDE_STYLES = {
    ...
    "Pencil Sketch": "A clean pencil sketch style featuring fine line art and subtle cross-hatching textures. The artwork uses a black-and-white monochrome palette with light graphite shading. Selectively, key focal elements are filled with brand-approved accent colors, rendered entirely in a matching colored pencil shading technique with visible texture. The background is a textured off-white handmade paper surface."
}
