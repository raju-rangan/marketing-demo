...
## Product Scale & Staging (CRITICAL)
Always render products at REAL-WORLD physical size relative to people and environments:
- Credit card: standard pocket size (~8.5cm x 5.5cm). Must be held naturally between fingers, resting inside a premium leather wallet, or placed flat on a high-end textured tabletop. Never enlarge to cover the screen or background.
