...
- [ ] **Financial Compliance Check (Banking/Credit products)**:
  - [ ] Ensure descriptions include regulatory disclaimers (`Subject to credit approval. Terms apply.`) if interest rates or rewards are advertised.
  - [ ] Verify no deceptive or unverified claims are made (e.g. "guaranteed approval", "completely free interest").
